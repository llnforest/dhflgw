...
class Siren extends BaseController{
    ...
    public function contentAdd(){
        if($this->request->isPost()){
            ...
            return operateResult($content,'siren/index','add');
        }
        $whe['mark'] = request()->controller();
    ...
    public function contentEdit(){
        ...
        if($this->request->isPost()){
           ...
           return operateResult(true,'siren/index','edit');
        }
    ...
    public function contentDelete(){
        if($this->request->isPost()) {
            ...
            return operateResult($result->delete(),'siren/index','del');
        }
    ...
    public function batchDelContent(){
        if($this->request->isPost()) {
            ...
            return operateResult($data,'siren/index','del');
        }
        return ['code'=>0,'msg'=>lang('sys_method_error')];
    }
