...
class Zixun extends BaseController{
    ...
    public function contentAdd(){
        if($this->request->isPost()){
            ...
            return operateResult($content,'zixun/index','add');
        }
        $whe['mark'] = request()->controller();
    ...
    public function contentEdit(){
        ...
        if($this->request->isPost()){
           ...
           return operateResult(true,'zixun/index','edit');
        }
    ...
    public function contentDelete(){
        if($this->request->isPost()) {
            ...
            return operateResult($result->delete(),'zixun/index','del');
        }
    ...
    public function batchDelContent(){
        if($this->request->isPost()) {
            ...
            return operateResult($data,'zixun/index','del');
        }
        return ['code'=>0,'msg'=>lang('sys_method_error')];
    }
