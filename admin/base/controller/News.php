...
class News extends BaseController{
    ...
    public function index(){
        ...
        $where  = getWhereParam(['a.title'=>'like'],$this->param);
    ...
    public function contentAdd(){
        if($this->request->isPost()){
            ...
            return operateResult($content,'news/index','add');
        }
        $whe['mark'] = request()->controller();
    ...
    public function contentEdit(){
        ...
        if($this->request->isPost()){
           ...
           return operateResult(true,'news/index','edit');
        }
    ...
    public function batchDelContent(){
        if($this->request->isPost()) {
            ...
            return operateResult($data,'news/index','del');
        }
        return ['code'=>0,'msg'=>lang('sys_method_error')];
    }
