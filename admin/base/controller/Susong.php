...
class Susong extends BaseController{
    ...
    public function contentAdd(){
        if($this->request->isPost()){
            ...
            return operateResult($content,'susong/index','add');
        }
        $whe['mark'] = request()->controller();
    ...
    public function contentEdit(){
        ...
        if($this->request->isPost()){
           ...
           return operateResult(true,'susong/index','edit');
        }
    ...
    public function contentDelete(){
        if($this->request->isPost()) {
            ...
            return operateResult($result->delete(),'susong/index','del');
        }
    ...
    public function batchDelContent(){
        if($this->request->isPost()) {
            ...
            return operateResult($data,'susong/index','del');
        }
        return ['code'=>0,'msg'=>lang('sys_method_error')];
    }
