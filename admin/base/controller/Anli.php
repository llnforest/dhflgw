...
class Anli extends BaseController{
    ...
    public function contentAdd(){
        if($this->request->isPost()){
            ...
            return operateResult($content,'anli/index','add');
        }
        $whe['mark'] = request()->controller();
    ...
    public function contentEdit(){
        ...
        if($this->request->isPost()){
           ...
           return operateResult(true,'anli/index','edit');
        }
    ...
    public function contentDelete(){
        if($this->request->isPost()) {
            ...
            return operateResult($result->delete(),'anli/index','del');
        }
    ...
    public function batchDelContent(){
        if($this->request->isPost()) {
            ...
            return operateResult($data,'anli/index','del');
        }
        return ['code'=>0,'msg'=>lang('sys_method_error')];
    }
